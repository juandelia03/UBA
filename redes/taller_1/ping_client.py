...
rtts = []
total_time_past = 0
while total_time_past < args.duration:
    rtt = send_ping()
    # el grafico toma puntos (momento en que se recibio relativo, rtt)
    received_at = time.time() - start
    point = (received_at, rtt)
    rtts.append(point)
    total_time_past =  time.time() - start
